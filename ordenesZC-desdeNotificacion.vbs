...
directorioSE = Trim(CStr(sheet1.Cells(1, 2).Value))
directorioChecklist = Trim(CStr(sheet1.Cells(2, 2).Value))
numeroPersona = Trim(CStr(objSheet.Cells(3, 2).Value))
equipoSeguridadElectrica = Trim(CStr(sheet1.Cells(4, 2).Value))
rigel = Trim(CStr(sheet1.Cells(5, 2).Value))
...
For i = 2 to objSheet.UsedRange.Rows.Count
   ...
   archivoSE = "SE-" + Trim(CStr(objSheet.Cells(i, 4).Value)) + ".pdf"
   archivoChecklist = "checklist-" + Trim(CStr(objSheet.Cells(i, 4).Value)) + ".pdf"
   textoDescriptivo = Trim(CStr(objSheet.Cells(i, 5).Value))
